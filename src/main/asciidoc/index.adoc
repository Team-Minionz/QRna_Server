...
==== 성공
.request
include::{snippets}/user_view_page_success/http-request.adoc[]

.response
include::{snippets}/user_view_page_success/http-response.adoc[]
==== 실패
.request
include::{snippets}/user_view_page_fail/http-request.adoc[]

.response
include::{snippets}/user_view_page_fail/http-response.adoc[]