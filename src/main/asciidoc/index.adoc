...
==== 성공
.request
include::{snippets}/user-visit-shop-success/http-request.adoc[]

.response
include::{snippets}/user-visit-shop-success/http-response.adoc[]
==== 실패
.request
include::{snippets}/user-visit-shop-fail/http-request.adoc[]

.response
include::{snippets}/user-visit-shop-fail/http-response.adoc[]
