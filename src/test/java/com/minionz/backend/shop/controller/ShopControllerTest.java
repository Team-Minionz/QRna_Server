...
class ShopControllerTest extends ApiDocument {
    ...
    @Test
    void 상점_등록_성공() throws Exception {
        ...
        ResultActions resultActions = 상점_등록_요청(shopRequestDto);
        상점_등록_요청_성공(message, resultActions);
    }

    @DisplayName("상점 등록 실패")
    @Test
    void 상점_등록_실패() throws Exception {
        Address address = new Address("인천시", "부평구", "산곡동");
        ShopRequestDto shopRequestDto = new ShopRequestDto("맥도날드", address, "032-123-1234");
        ...
        ResultActions resultActions = 상점_등록_요청(shopRequestDto);
        상점_등록_요청_실패(message, resultActions);
    }

    @DisplayName("상점 update 성공")
    @Test
    void 상점_수정_성공() throws Exception {
        Long id = 1L;
        Address address = new Address("인천시", "부평구", "산곡동");
        ShopRequestDto shopRequestDto = new ShopRequestDto("맥도날드", address, "032-123-1234");
        ...
        ResultActions resultActions = 상점_수정_요청(id, shopRequestDto);
        상점_수정_요청_성공(resultActions);
    }

    @DisplayName("상점 update 실패")
    @Test
    void 상점_수정_실패() throws Exception {
        Long id = 1L;
        Address address = new Address("인천시", "부평구", "산곡동");
        ShopRequestDto shopRequestDto = new ShopRequestDto("맥도날드", address, "032-123-1234");
        ...
        ResultActions resultActions = 상점_수정_요청(id, shopRequestDto);
        상점_수정_요청_실패(message, resultActions);
    }

    @DisplayName("상점 delete 성공")
    @Test
    void 상점_삭제_성공() throws Exception {
        Long id = 1L;
        Message message = new Message("Shop 삭제 성공");
        willReturn(message).given(shopService).delete(any(Long.class));
        ResultActions resultActions = 상점_삭제_요청(id);
        상점_삭제_요청_성공(resultActions);
    }

    @DisplayName("상점 delete 실패")
    @Test
    void 상점_삭제_실패() throws Exception {
        Long id = 1L;
        Message message = new Message("Shop 삭제 실패");
        willThrow(new NotFoundException("Shop 삭제 실패")).given(shopService).delete(any(Long.class));
        ResultActions resultActions = 상점_삭제_요청(id);
        상점_삭제_요청_실패(message, resultActions);
    }

    private void 상점_삭제_요청_실패(Message message, ResultActions resultActions) throws Exception {
    ...
    private void 상점_수정_요청_실패(Message message, ResultActions resultActions) throws Exception {
        resultActions.andExpect(status().isNotFound())
                .andExpect(content().json(toJson(message)))
                .andDo(print())
    ...
    private void 상점_등록_요청_실패(Message message, ResultActions resultActions) throws Exception {
    ...
    private void 상점_등록_요청_성공(Message message, ResultActions resultActions) throws Exception {
    ...
    private void 상점_수정_요청_성공(ResultActions resultActions) throws Exception {
        resultActions.andExpect(status().isNoContent())
                .andDo(print())
                .andDo(toDocument("shop-update-success"));
    }

    private ResultActions 상점_수정_요청(Long id, ShopRequestDto shopRequestDto) throws Exception {
        return mockMvc.perform(put("/api/v1/shops/" + id)
                .content(objectMapper.writeValueAsString(shopRequestDto))
                .contentType(MediaType.APPLICATION_JSON));
    }

    private void 상점_삭제_요청_성공(ResultActions resultActions) throws Exception {
        resultActions.andExpect(status().isNoContent())
                .andDo(print())
                .andDo(toDocument("shop-delete-success"));
    }

    private ResultActions 상점_삭제_요청(Long id) throws Exception {
